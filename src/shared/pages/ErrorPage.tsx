...
function ErrorPage() {
  return (
    <PageBackground>
      ...
      {/*웹*/}
      <section className="relative hidden w-full flex-col lg:absolute lg:top-0 lg:left-224.25 lg:z-10 lg:flex lg:h-190 lg:w-135.75 lg:px-13.75 lg:pt-15 lg:pb-12.5">
