...
function MaintenancePage() {
  return (
    <PageBackground>
      <section className="relative flex w-full flex-col px-8 py-10 sm:px-14 lg:absolute lg:top-0 lg:left-224.25 lg:z-10 lg:h-190 lg:w-135.75 lg:px-13.75 lg:pt-15 lg:pb-12.5">
